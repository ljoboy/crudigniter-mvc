                            ...
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        <label>ID Anda</label>
                                        <input type="text" name="id" class="form-control" value="<?php echo strtoupper($er['id'])?>" minlength="2" maxlength="7" required readonly>
                            ...
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" value="<?php echo ucwords($er['nama'])?>" minlength="2" maxlength="40" required tabindex="1">
                                        <span class="small text-danger">
