                            ...
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Silahkan masukan email" value="<?php echo set_value('email')?>" max_length="40" required tabindex="1">
                            ...
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="no_telp" class="form-control" placeholder="Silahkan masukan no telepon" value="<?php echo set_value('no_telp')?>" max_length="12" required tabindex="2">
                                        <span class="small text-danger">
