                        ...
                        <table class="table table-sm table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if(is_array($tgl) || is_object($tgl))
                                {
                                    ...
                                    {
                                        $no++;
                                        $tgl_lahir = date('Y-m-d',strtotime($er['tgl_lahir']));
                                        ?>
                                <tr>
                                    <td><?php echo $no?></td>
                                    <td><?php echo tgl_indo($tgl_lahir, true)?></td>
                                    <td><?php echo $er['umur'].' Tahun'?></td>
                                    <td class="text-right">
                                        <button class="btn btn-danger btn-sm hapus" data-toggle="modal" data-target="#konfirm" data-id="<?php echo $er['id']?>" data-tanggal="<?php echo tgl_indo($tgl_lahir, true)?>">
...
$(document).on("click",'.hapus',function()
{
    ...
    $(".teks").text("Anda yakin menghapus data dengan tanggal lahir "+tgl+" ?");
