...
<head>
    ...
    <title>CRUD - Tanggal Tambah</title>
                        ...
                        <div class="row mb-2">
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="tgl" name="tgl_lahir" class="form-control" value="<?php echo set_value('tgl_lahir')?>" min="<?php echo $fix_min?>" max="<?php echo $fix_max?>" required tabindex="1">
                            ...
                            <div class="table-responsive col-lg-4">
                                <div class="panel-body mt-2">
                                    <div class="form-group">
                                        <label>Umur</label>
                                        <input type="text" id="umur" name="umur" class="form-control" value="<?php echo set_value('umur')?>" minlength="1" maxlength="9" required readonly>
                                        <span class="small text-danger">
