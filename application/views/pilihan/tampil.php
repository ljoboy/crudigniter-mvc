            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-hover" id="pilihan" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Jenis Kelamin</th>
                            ...
                            <tbody>
                                ...
                                if(is_array($plh) || is_object($plh))
                                {
                                    ...
                                    {
                                        $no++;
                                        $hobi = explode(',',$er['hobi']);
                                        ?>
                                <tr>
                                    <td><?php echo $no ?></td>
                                    <td><?php echo ucwords($er['jenis_kelamin'])?></td>
                                    <td>
                                        <?php
                                        foreach($hobi as $hb)
                                        {
                                    ...
                                    <td class="text-right">
                                        <button class="btn btn-danger btn-sm hapus" data-toggle="modal" data-target="#konfirm" data-id="<?php echo $er['id']?>">
...
$(document).on("click",'.hapus',function()
{
    ...
    $(".teks").text("Anda yakin menghapus data tersebut ?");
