                            ...
                            <div class="table-responsive col-lg-12">
                                <div class="panel-body">
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="text" name="gambar_awal" value="<?php echo $er['gambar']?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Judul Artikel <i class="text-danger">*</i></label>
                                        <textarea class="form-control" name="judul" minlength="20" maxlength="200" required tabindex="1"><?php echo ucwords($er['judul'])?></textarea>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <img id="preview" class="form-control preview" src="<?php echo base_url()?>data/artikel/<?php echo $er['gambar']?>">
                                    </div>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea id="isi" class="form-control" name="isi" style="height: 500px" minlength="200" maxlength="65535" required tabindex="3"><?php echo $er['isi']?></textarea>
                                        <span class="small text-danger">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Tag</label>
                                        <input type="text" class="form-control" id="tag" name="tag" data-role="tagsinput" value="<?php echo $er['tag']?>" maxlength="200" required tabindex="4">
                                        <span class="small text-danger">
...
$(document).ready( function()
{
    ...
    {
        $("img#preview").attr('src','<?php echo base_url()?>data/artikel/<?php echo $er['gambar']?>');
    });
