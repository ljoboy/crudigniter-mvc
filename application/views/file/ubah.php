                            ...
                            <div class="table-responsive col-lg-6">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>File awal
                                            <text class="small">(klik nama file dibawah ini untuk melihat.)</text>
                                        </label><br>
                            ...
                            <div class="table-responsive col-lg-6">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" placeholder="Silahkan masukan nama gambar" value="<?php echo ucwords($er['nama'])?>" maxlength="40" required tabindex="1">
                                        <span class="small text-danger">
