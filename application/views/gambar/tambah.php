...
<head>
    ...
    <title>CRUD - Gambar Tambah</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
                            ...
                            <div class="table-responsive col-lg-6">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <img id="preview" class="form-control img-thumbnail">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive col-lg-6 mt-2">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" placeholder="Silahkan masukan nama gambar" value="<?php echo set_value('nama')?>" maxlength="40" required tabindex="2">
                                        <span class="small text-danger">
    ...
    <div id="crop-modal" class="modal fade" role="document">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    <center>
                        <h5>Crop Gambar</h5>
                        <img class="img-crop mt-2 mb-3 center">
                        <div class="mt-4">
                            ...
                            <button class="btn btn-primary btn-sm pl-3 pr-3 iya" type="button">
                                <i class="fa fa-fw fa-crop"></i>  Crop
                            </button>
                        </div>
                    </center>
            </div>
    ...
    <script src="<?php echo base_url() ?>vendor/lightbox/ekko-lightbox.js"></script>
</body>
</html>
